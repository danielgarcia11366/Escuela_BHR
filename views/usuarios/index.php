...
<div class="container-fluid mt-4">
    ...
    <button id="btnFlotante" class="floating-btn" title="Nuevo Usuario">
            ...
            <div class="form-container">
                <div class="form-header">
                    <h3>
                        ...
                        <span id="tituloFormulario">Nuevo Usuario</span>
                    </h3>
                </div>

                <form id="formUsuario" class="form-body">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-12">
                            ...
                            <small class="text-muted">Número de catálogo único del usuario</small>
                        </div>
                    </div>
                    ...
                    <div class="alert alert-info d-flex align-items-center mb-4">
                        ...
                        <small>El usuario podrá cambiar su contraseña después del primer inicio de sesión.</small>
                    </div>
                    ...
                    <div class="row">
                        <div class="col" id="contenedorBtnGuardar">
                            <button type="submit" id="btnGuardar" class="btn btn-primary-custom w-100">
                                <i class="bi bi-save-fill"></i> Crear Usuario
                            </button>
                        </div>
        ...
        <div class="col-12">
            <div class="table-container">
                ...
                <div class="table-responsive">
                    <table id="tablaUsuarios" class="table table-hover"></table>
                </div>
            </div>
        </div>
    </div>
