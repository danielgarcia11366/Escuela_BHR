    ...
    <nav class="navbar navbar-expand-lg navbar-dark  bg-dark">
        ...
        <div class="container-fluid">
            ...
            <a class="navbar-brand" href="/Escuela_BHR/">
                <img src="<?= asset('./images/bhr.jpeg') ?>" width="35px'" alt="cit">
                Escuela BHR
            </a>
            <div class="collapse navbar-collapse" id="navbarToggler">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0" style="margin: 0;">
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="/Escuela_BHR/"><i class="bi bi-house-fill me-2"></i>Inicio</a>
                    </li>
                    ...
                    <div class="nav-item dropdown ">
                        ...
                        <ul class="dropdown-menu  dropdown-menu-dark " id="dropwdownRevision" style="margin: 0;">
                            ...
                            <li>
                                <a class="dropdown-item nav-link text-white " href="/Escuela_BHR/cursos"><i class="bi bi-eye-fill"></i> Gestión de Cursos</a>
                            </li>
                    ...
                    <div class="nav-item dropdown ">
                        ...
                        <ul class="dropdown-menu  dropdown-menu-dark " id="dropwdownRevision" style="margin: 0;">
                            <!-- <h6 class="dropdown-header">Información</h6> -->
                            <li>
                                <a class="dropdown-item nav-link text-white " href="/Escuela_BHR/alumnos"><i class="bi bi-list-columns"></i> Listado por Promoción</a>
                            </li>
                            <li>
                                <a class="dropdown-item nav-link text-white " href="/Escuela_BHR/alumnos"><i class="bi bi-bar-chart-fill"></i> Estadisticas</a>
                            </li>
